...
function initializeBears() {
    ...
    const bearImages = [
        'https://ur-bee-loved.neocities.org/bichinhos/abelha.png',
        'https://ur-bee-loved.neocities.org/bichinhos/anomolocaris.png',
        'https://ur-bee-loved.neocities.org/bichinhos/bart.png',
        'https://ur-bee-loved.neocities.org/bichinhos/coelho.png',      
        'https://ur-bee-loved.neocities.org/bichinhos/gato.png', 
        'https://ur-bee-loved.neocities.org/bichinhos/mariposa.png', 
        'https://ur-bee-loved.neocities.org/bichinhos/morango.png', 
        'https://ur-bee-loved.neocities.org/bichinhos/ovelinha.png', 
        'https://ur-bee-loved.neocities.org/bichinhos/pombo.png', 
        'https://ur-bee-loved.neocities.org/bichinhos/rabanete.png', 
        'https://ur-bee-loved.neocities.org/bichinhos/rato.png', 
        'https://ur-bee-loved.neocities.org/bichinhos/regaleco.png', 
        'https://ur-bee-loved.neocities.org/bichinhos/snail.png', 
        'https://ur-bee-loved.neocities.org/bichinhos/tubaraoduende.png', 
        'https://ur-bee-loved.neocities.org/bichinhos/viado.png', 
    ];
...
function dropPlushie(index) {
    ...
    setTimeout(() => {
        ...
        // Redirect to loading page instead of directly to chat
        window.location.href = `https://ur-bee-loved.neocities.org/loading?plushie=${filename}`;
    }, 1000);
}
